...
export default function EditChildPanel({ onClose }: { onClose: () => void }) {
     /*DONT FORGET to set default value from json */
     ...
     return (
          <div className="absolute z-50 flex flex-col items-center text-start justify-center w-72 bg-white rounded-lg shadow-md lg:max-w-screen-sm">
