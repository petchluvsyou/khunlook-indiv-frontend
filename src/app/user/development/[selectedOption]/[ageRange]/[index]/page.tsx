...
export default function DevelopmentDetailPage({
  ...
  params: { selectedOption: string; ageRange: string; index: string };
}) {
  const [currentData, setCurrentData] = useState<any>();
  const selectedOption = decodeURIComponent(params.selectedOption) as
    | "เด็กปฐมวัย"
    | "เด็กกลุ่มเสี่ยง";
  ...
  return (
    <div className="flex justify-center items-center text-center relative z-0 flex-col p-12 bg-[#F8F8F8] gap-1 top-[64px] sm:top-[92px] w-full">
