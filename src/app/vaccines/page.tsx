        ...
        {vaccineOption === "required" ? (
          age === "lt1" ? (
            <div className="grid grid-cols-7 gap-1 bg-white p-10 rounded-md shadow-lg m-4">
              ...
              <div className="col-span-1 bg-Bg p-4 text-center rounded-md">
                BCG
              </div>
              ...
              <div className="col-span-2 bg-Bg p-4 text-center rounded-md">
                MMR1
              </div>
          ...
          <div className="grid grid-cols-6 gap-1 bg-white p-10 rounded-md shadow-lg m-4">
            ...
            <div className="col-span-1 p-4"></div>
            <div className="bg-Bg p-4 text-center rounded-md">
              DTP-IPV-Hib 2
            </div>
            ...
            <div className="col-span-2 p-4"></div>
            <div className="col-span-3 bg-Bg p-4 text-center rounded-md">
              Influenza ให้ปีละครั้งช่วงอายุ 6 เดือน - 18 ปี (เน้นในอายุ 6-24
              เดือน) ในปีแรกฉีด 2 เข็มห่างกัน 4 สัปดาห์
            </div>
          ...
          <div className="grid grid-cols-6 gap-1 bg-white p-10 rounded-md shadow-lg m-4">
            ...
            {/* FLU */}
            <div className="bg-Bg p-4 rounded-md">วัคซีนไข้หวัดใหญ่ (Flu)</div>
            <div className="col-span-5 bg-Bg p-4 text-center rounded-md">
              Influenza ให้ปีละครั้งช่วงอายุ 6 เดือน - 18 ปี (เน้นในอายุ 6-24
              เดือน) ในปีแรกฉีด 2 เข็มห่างกัน 4 สัปดาห์
            </div>
